...
function RegisterPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (form.whatsapp.replace(/\D/g, "").length < 10) return toast.error("Enter a valid WhatsApp number.");
    ...
    <div className="page-container section-y max-w-md">
      ...
      <form onSubmit={submit} className="mt-6 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input id="password" type="password" autoComplete="new-password" className="h-11" value={form.password} onChange={set("password")} required />
